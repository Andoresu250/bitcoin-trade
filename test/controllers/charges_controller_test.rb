...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { amount: @charge.amount, evidence: @charge.evidence, person_id: @charge.person_id, state: @charge.state } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount: @charge.amount, evidence: @charge.evidence, person_id: @charge.person_id, state: @charge.state } }
