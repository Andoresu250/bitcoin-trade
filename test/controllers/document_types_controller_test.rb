...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { abbreviation: @document_type.abbreviation, country_id: @document_type.country_id, name: @document_type.name } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { abbreviation: @document_type.abbreviation, country_id: @document_type.country_id, name: @document_type.name } }
